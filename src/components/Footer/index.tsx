...
import logo from "../../../public/mind.png";

const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp pt-10 px-16 relative z-10 bg-primary bg-opacity-5 md:pt-20 md:px-24 lg:pt-24"
        data-wow-delay=".1s"
      >
        ...
        <div className="bg-primary/10 py-8"></div>
